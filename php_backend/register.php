...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($check_email) > 0) {
        ...
        $_SESSION['reg_data']['org_pass1'] = $hashed_password;
...
<head>
    ...
    <title>Organization Registration | SmartPresence: Face Recognition Attendance, Billing & Subscription</title>
...
<body>
    ...
    <div class="register-container">
        <div class="register-header">
            ...
            <p>Register your organization to start using SmartPresence platform</p>
        </div>
